 ...
 */
public class RetroCardRequest implements Request {
  ...
  public RetroCardRequest(ResourceLoader resourceLoader, RetroCardManagement management) {
  ...
  private void handleSiteRequest(RequestData requestData, Responder responder,
    ...
    if (requestData.getFiles().size() == 1) {
      ...
      if (!revision.isPresent()) {
        ...
        responder.respond(String.format("Firmware for revision %d added successfully as version %d",
