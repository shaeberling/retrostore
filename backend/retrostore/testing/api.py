...
from retrostore.api.storage import CatalogEntry, InMemoryApiDataStore, MediaSlot
...
_EXPECTED_MEDIA_RESPONSE_SHA256 = "773c39cabf958c7993e243cf1e05242ab4a061808afe9df107aa5eb0772d40e3"


def representative_storage() -> InMemoryApiDataStore:
    ...
    return InMemoryApiDataStore(catalog, {_FIXTURE_APP_ID: media_slots})
