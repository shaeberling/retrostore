...
import retrostore.migration.catalog_mirror.import_catalog as import_command
from retrostore.migration.catalog_mirror.google_cloud import validate_catalog_target
from tests.migration.catalog_mirror.test_archive import _write_archive
from tests.migration.catalog_mirror.test_persistence import MemoryObjectStore, MemorySnapshotStore
...
def test_apply_imports_through_injected_stores_and_reports_reconciliation(
    ...
    assert report["service_account"] == ("retrostore-migrator@trs-80.iam.gserviceaccount.com")
