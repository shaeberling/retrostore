...
from retrostore.migration.catalog_mirror.verify_archive import build_verification_report, main
...
def test_command_prints_compact_json(tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    path = tmp_path / "catalog.zip"
    _write_archive(path)
