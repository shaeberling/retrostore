...
/* Generated by nanopb-0.3.9.1 at Sat Apr 14 13:56:14 2018. */
...
const pb_field_t ApiResponseApps_fields[4] = {
    ...
    PB_FIELD(  2, STRING  , SINGULAR, CALLBACK, OTHER, ApiResponseApps, message, success, 0),
...
const pb_field_t ApiResponseMediaImages_fields[4] = {
    ...
    PB_FIELD(  2, STRING  , SINGULAR, CALLBACK, OTHER, ApiResponseMediaImages, message, success, 0),
...
const pb_field_t App_fields[9] = {
    ...
    PB_FIELD(  2, STRING  , SINGULAR, CALLBACK, OTHER, App, name, id, 0),
    PB_FIELD(  3, STRING  , SINGULAR, CALLBACK, OTHER, App, version, name, 0),
    PB_FIELD(  4, STRING  , SINGULAR, CALLBACK, OTHER, App, description, version, 0),
    ...
    PB_FIELD(  7, STRING  , SINGULAR, CALLBACK, OTHER, App, author, screenshot_url, 0),
...
const pb_field_t MediaImage_fields[6] = {
    ...
    PB_FIELD(  2, STRING  , SINGULAR, CALLBACK, OTHER, MediaImage, filename, type, 0),
    ...
    PB_FIELD(  5, STRING  , SINGULAR, CALLBACK, OTHER, MediaImage, description, uploadTime, 0),
    PB_LAST_FIELD
};
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(App, ext_trs80) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_ApiResponseApps_ApiResponseMediaImages_App_Trs80Extension_MediaImage)
#endif
