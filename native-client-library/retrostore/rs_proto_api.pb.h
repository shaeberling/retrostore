...
#ifndef PB_RS_PROTO_API_PB_H_INCLUDED
#define PB_RS_PROTO_API_PB_H_INCLUDED
#include <pb.h>
...
#define App_init_default                         {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, {{NULL}, NULL}, {{NULL}, NULL}, Trs80Extension_init_default}
...
#define App_init_zero                            {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, {{NULL}, NULL}, {{NULL}, NULL}, Trs80Extension_init_zero}
